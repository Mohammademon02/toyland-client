...
const Footer = () => {
    return (
        <footer className="fixed bottom-0 footer footer-center p-10 bg-neutral-focus text-primary-content">
            <div>
                ...
                <p className="font-bold">
                    TOYLAND Marketplace <br />Providing reliable tech since 1992
                </p>
