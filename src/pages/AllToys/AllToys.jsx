    ...
    return (
        ...
        <section className="container mx-auto">
            ...
            <form onSubmit={handleSearch} className="flex items-center my-9">
                ...
                <button type="submit" className="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-gradient-to-r from-[#1CB5E0] to-[#000851]  rounded-lg border focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    ...
                    <div className="flex gap-3 text-center flex-wrap justify-center">
                        {pageNumbers.map((number) => (
                            ...
                            <button
                                ...
                                type="button" className={currentPage === number ? 'w-3 h-3 border bg-gradient-to-r from-[#1CB5E0] to-[#000851] text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-4 inline-flex items-center justify-center' : 'w-3 h-3 text-blue-700 border border-blue-700 hover:bg-gradient-to-r from-[#1CB5E0] to-[#000851] hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-4 inline-flex items-center justify-center'}>
                                {number + 1}
                            </button>
                        ))}
                    </div>
